    ...
    <TabsWrapper>
      <div className='tabs'>
        <ul className="flex flex-wrap">
          ...
          <li className="tabs-head-item">
            <button type="button" className={`tab-btn ${activeTab === WEB_DEVELOPMENT}`} onClick={() => tabHandler(WEB_DEVELOPMENT)}>Desenvolvimento Web</button>
          </li>
          <li className="tabs-head-item">
            <button type="button" className={`tab-btn ${activeTab === DATA_SCIENCE}`} onClick={() => tabHandler(DATA_SCIENCE)}>Ciência de Dados</button>
          </li>
          <li className="tabs-head-item">
            <button type="button" className={`tab-btn ${activeTab === AWS}`} onClick={() => tabHandler(AWS)}>AWS</button>
          </li>
          <li className="tabs-head-item">
