    ...
    <SingleCourseWrapper>
        ...
        <div className="course-details">
          ...
          <div className="course-body">
            ...
            <ul className="course-info">
              <li>
                <span className="fs-14">Criado por <span className="fw-6 opacity-08">{creator}</span></span>
              </li>
              <li className='flex'>
                <span><MdInfo /></span>
                <span className="fs-14 course-info-txt fw-5">Última atualização {updated_date}</span>
              </li>
              <li className='flex'>
                <span><TbWorld /></span>
          ...
          <div className="course-foot">
            <div className="course-price">
              <span className="new-price fs-26 fw-8">R${discounted_price}</span>
              <span className="old-price fs-26 fw-6">R${actual_price}</span>
            </div>
          </div>
      ...
      <div className="course-full bg-white text-dark">
        <div className="course-learn mx-auto">
          <div className="course-sc-title">O que você vai aprender</div>
        ...
        <div className="course-content mx-auto">
          <div className="course-sc-title">Conteúdo do Curso</div>
